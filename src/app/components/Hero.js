      ...
      <section className="flex px-[9%] flex-col h-[700px] lg:flex-row gap-[2%] 2xl:gap-[5%] pt-[5%] items-start justify-center">
        <div className="lg:w-[60%] space-y-8">
          ...
          <div className="flex gap-8">
            ...
            <button className="bg-transparent border-2 border-[#28C0F5] hover:bg-[#28C0F5] duration-300 hover:text-white text-[#28C0F5] py-2 md:py-4 px-6 md:px-9 rounded-full text-[15px] md:text-[17px] font-[500]">
              Verify email
            </button>
          </div>
        </div>
